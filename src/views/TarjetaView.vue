<template>
  <div>
                ...
                <label for="cardName" class="card-item__info" ref="cardName">
                  ...
                  <transition name="slide-fade-up">
                    <div class="card-item__name" v-if="cardName.length" key="1">
                        <input type="text" v-model="cardName" class="text-white">
                    ...
                    <div class="card-item__name" v-else key="2">Nombre y Apellido</div>
                  </transition>
                </label>
        ...
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label">Expiración</label>
   ...
   <!-- <input type="text" v-model="this.pago.total" value="{{$route.params.totalVar}}" /> -->
  </div>
</template>
